                    ...
                    <div class="layui-col-xs6">
                        ...
                        <div class="layui-input-block">
                            <input type="text" class="layui-input"
                                   ...
                                   value="${(saleChance.customerName)!}" readonly="readonly">
                        </div>
                    </div>
                    <div class="layui-col-xs6">
                        ...
                        <div class="layui-input-block">
                            <input type="text" class="layui-input"
                                   ...
                                   value="${(saleChance.chanceSource)!}" readonly="readonly">
                        </div>
                    </div>
                </div>
                <div class="layui-form-item layui-row">
                    <div class="layui-col-xs6">
                        ...
                        <div class="layui-input-block">
                            <input type="text" class="layui-input"
                                   ...
                                   value="${(saleChance.linkMan)!}" readonly="readonly">
                        </div>
                    </div>
                    <div class="layui-col-xs6">
                        ...
                        <div class="layui-input-block">
                            <input type="text" class="layui-input"
                                   ...
                                   value="${(saleChance.linkPhone)!}" id="phone" readonly="readonly">
                        </div>
                    </div>
                </div>
                <div class="layui-form-item layui-row">
                    <div class="layui-col-xs6">
                        ...
                        <div class="layui-input-block">
                            <input type="text" class="layui-input"
                                   name="overview"
                                   value="${(saleChance.overview)!}" id="phone" readonly="readonly">
                        </div>
                    </div>
                    <div class="layui-col-xs6">
                        ...
                        <div class="layui-input-block">
                            <input type="text" class="layui-input"
                                   name="cgjl" value="${(saleChance.cgjl)!}"
                                   readonly="readonly">
                        </div>
                    </div>
                </div>
...
<div class="layui-col-md12">
    <table id="cusDevPlanList" class="layui-table" lay-filter="cusDevPlans">
    </table>
</div>
<#-- 如果开发状态是 0=未开发 和 1=开发中，则显示头部工具栏和行工具栏 -->
<#if (saleChance.devResult)??>
...
<script type="text/javascript" src="${ctx}/js/cusDevPlan/cus.dev.plan.data.js">
</script>
</body>
</html>
