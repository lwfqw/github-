...
searchVal" placeholder="创建人" />
    ...
    <script id="op" type="text/html" >
        ...
        <a href="javascript:;" class="layui-btn layui-btn-warm layui-btnxs" lay-event="dev">开发</a>
        {{# } else { }}
        <a href="javascript:;" class="layui-btn layui-btn-normal layuibtn-xs" lay-event="info">详情</a>
        {{# } }}
    </script>
</form>
