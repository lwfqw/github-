...
<html>
    ...
    <body class="childrenBody">
        <form class="layui-form" style="width:80%;">
            <input name="id" id="uid" type="hidden" value="${(user.id)!}"/>
...
<#--            密码,更新用户显示-->
                ...
                <div class="layui-form-item layui-row layui-col-xs12">
                    ...
                    <div class="layui-input-block">
                        <input type="password" class="layui-input userName"
                               lay-verify="required" name="userPwd" id="userPwd" value="${(user.userPwd)!}" placeholder="请输入密码">
                    </div>
                </div>
                <div class="layui-form-item layui-row layui-col-xs12">
                    ...
                    <div class="layui-input-block">
                        <input type="password" class="layui-input userName"
                               lay-verify="required" name="confirPWD" id="confirPWD" value="${(user.trueName)!}" placeholder="请确认密码">
                    </div>
                </div>
            </#if>
            ...
            <div class="magb15 layui-col-md4 layui-col-xs12">
                ...
                <div class="layui-input-block">
                    <select id="myselect" name="roleIds" xm-select="selectId"> </select>
                </div>
            </div>
