                ...
                <ul class="layui-nav layui-nav-tree layui-left-nav-tree layui-this" id="currency">
                    <#if privalige?seq_contains("10")>
                        <li class="layui-nav-item">
                            ...
                            <dl class="layui-nav-child">
                                <#if privalige?seq_contains("1010")><dd>
                                ...
                                <#if privalige?seq_contains("1020")> <dd>
                    ...
                    <#if privalige?seq_contains("20")>
                        <li class="layui-nav-item">
                            <a href="javascript:;" class="layui-menu-tips"><i class="fa fa-flag"></i><span class="layui-left-nav"> 客户管理</span> <span class="layui-nav-more"></span></a><dl class="layui-nav-child">
                                <#if privalige?seq_contains("2010")><dd>
                                ...
                                <#if privalige?seq_contains("2020")> <dd>
