layui.use(['form', 'layer','formSelects'], function () {
    ...
    formSelects.config('selectId',{
      ...
      //       $.get(ctx+"/role/queryOneRoles?userId="+$("#uid").val(),function (MSG) {
      //           console.log(MSG);
      //           for (var i=0;i<MSG.length;i++){
      //               $("option[value="+MSG[i].id+"]").prop("selected","selected");
      //           }
      //       });
      //   }
        /**
    ...
    //密码验证
    $("#confirPWD").onblur=function () {
        if ($("#confirPWD").val()!=$("#userPwd").val()){
